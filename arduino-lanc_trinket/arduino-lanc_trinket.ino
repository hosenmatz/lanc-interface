...
//trinket settings
#define cmdPinON (PORTB = B00000100)   // Set digtal pin 2 (PB2)
#define cmdPinOFF (PORTB = B00000000)  // Reset digtal pin 2 (PB2)
...
void setup() {
 //DDRB = DDRB | B00000100;    // Config cmdPin as output
 //DDRB = DDRB & B11111110;    // Config lancPin as input
 //DDRB = DDRB | B00000010;    // Config ledPin as output
 pinMode(cmdPin, OUTPUT);
 pinMode(lancPin, INPUT_PULLUP);    // Listens to the LANC line, used for pulseIn function 
